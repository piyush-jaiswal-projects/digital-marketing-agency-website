...
function founders(){
    ...
    <p class="service-para found-para">Expert in developing websites, social media marketing and content creation.</p>
    </div>
    ...
    <h4 class="founder-tagline">Co-founder</h4>
    <p class="service-para found-para">Certified digital marketer, helped many brands to grow their presence from zero to 2M+ following.</p>
    </div>
    </div>
    </div>
    );
